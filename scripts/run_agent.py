...
def call_claude(system_prompt, user_message):
    ...
    if not API_KEY:
        print("Error: ANTHROPIC_API_KEY or CLAUDE_API_KEY environment variable is missing.")
        return None
...
def main():
    if not API_KEY:
        ...
        print("3. Name: CLAUDE_API_KEY")
        print("4. Value: Your Anthropic API key (starts with 'sk-ant-')")
        sys.exit(1)
